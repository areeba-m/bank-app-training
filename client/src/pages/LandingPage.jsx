          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.15]">
                ...
                <span className="bg-gradient-to-r from-burgundy-700 via-burgundy-800 to-burgundy-950 bg-clip-text text-transparent">
                  Security & Simplicity
                </span>
              </h1>

              <p className="text-base text-slate-600 max-w-xl leading-relaxed">
                Manage accounts, track transactions, and monitor balances with a
                secure and intuitive banking platform.
              </p>
              ...
              <div className="bg-white p-6 rounded-3xl shadow-xl border border-burgundy-100/80 relative z-10">
                <div className="bg-gradient-to-br from-burgundy-900 via-burgundy-800 to-burgundy-950 text-white p-6 rounded-2xl shadow-burgundy-lg relative overflow-hidden aspect-[1.586/1] flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-start relative z-10">
                    <div>
                      <p className="text-[9px] uppercase font-bold tracking-widest text-burgundy-200">
                        AURA PREMIER
                      </p>
                      <p className="text-xs font-bold text-white tracking-wide mt-0.5">
                        Digital Account
                      </p>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-xl mx-auto mb-8">
            ...
            <p className="text-xs text-slate-500 mt-1">
              Powerful features designed to provide a seamless digital banking
              experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="p-5 bg-sand-50/70 rounded-2xl border border-burgundy-200/80 shadow-xs space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Protected authentication and role-based access control ensure
            ...
            <div className="p-5 bg-sand-50/70 rounded-2xl border border-burgundy-200/80 shadow-xs space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Create, track, and manage transactions with real-time balance
                updates and DB/CR indicators.
              </p>
            </div>
            ...
            <div className="p-5 bg-sand-50/70 rounded-2xl border border-burgundy-200/80 shadow-xs space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Enjoy a responsive banking interface built with modern
                technologies and intuitive workflows.
              </p>
            </div>
          </div>
        </div>
