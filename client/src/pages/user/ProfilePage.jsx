...
import { User, Mail, MapPin, Key, CheckCircle2 } from 'lucide-react';
        ...
        <div className="max-w-3xl space-y-5">
            ...
            <div className="bg-white rounded-3xl p-6 border border-burgundy-100/80 shadow-xs space-y-5">
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <h2 className="text-sm font-extrabold text-slate-900">Account Attributes</h2>
            ...
            <CheckCircle2 className="w-4 h-4" /> Verified
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    ...
                    <div className="p-3.5 bg-sand-50/70 rounded-2xl border border-slate-200 space-y-0.5">
                        ...
                        <p className="font-mono font-bold text-slate-900 text-xs">{user?.id}</p>
                    </div>
                    ...
                    <div className="p-3.5 bg-sand-50/70 rounded-2xl border border-slate-200 space-y-0.5">
                        ...
                        <p className="font-mono font-bold text-slate-900 text-xs">•••••••• ({user?.password})</p>
                    </div>
                    ...
                    <div className="sm:col-span-2 p-3.5 bg-sand-50/70 rounded-2xl border border-slate-200 space-y-0.5">
                        ...
                        <p className="font-bold text-slate-900 text-xs">{user?.address || 'No address registered'}</p>
                    </div>
